  ...
  .directive('holmesfooter', () ->
    ...
    <footer>
      <div class="container light-grey fs0">
        <p class="ib">holmes is a free open-source project and is composed of <a target="_blank" class="blue under-hover" href="http://github.com/heynemann/holmes-web/">holmes-web ({{ holmesWebVersion }})</a> and <a target="_blank" class="blue under-hover" href="http://github.com/heynemann/holmes-api/">holmes-api ({{ apiVersion }})</a>.</p>
        ...
        <p class="ib pull-right">Copyright <a target="_blank" class="blue under-hover" href="http://opensource.globo.com">globo.com</a> - MIT Licensed - 2013</p>
      </div>
    </footer>
    """
    restrict: 'E'
